...
class _QuestionState extends State<Question>{
    ...
    Widget build(BuildContext context) {
      Widget buttonAnswer(String title) {
          return Container(margin: EdgeInsets.fromLTRB(0, 20, 0, 20),child: TextButton(style: TextButton.styleFrom(minimumSize: Size(MediaQuery.of(context).size.width/2.6, 35)),
          onPressed: (){}, child: Text(title,style: TextStyle(color: Colors.black,fontSize: 17),)),decoration: BoxDecoration(color: Colors.white,border:Border.all(width: 3),borderRadius: BorderRadius.circular(40)),);
      }
      return Scaffold(
        appBar: AppBar(centerTitle: true,title: Text('Sport',style: TextStyle(color: Color.fromARGB(255, 55, 55, 55),fontSize: 30,fontWeight: FontWeight.bold),),
        ...
        body: Container(
          ...
          children: <Widget>[ 
           Expanded(child:  Column(children: [
            Row(children: [
              Expanded(child: Text('Điểm 00',style: TextStyle(fontSize: 23),)),
              Text('Thời gian : 30s',style: TextStyle(fontSize: 23),)
            ],),
            Container(
